...
void next()
{
  ...
  { 
    ...
    enqueuecommands_P((PSTR("G1 X30 Y30 F5000"))); // Coordinated Movement X:30mm Y:30mm
  ...
  if(i==2)
  {
    ...
    enqueuecommands_P((PSTR("G1 Y190 F5000"))); // Coordinated Movement X:30mm Y:190mm
    enqueuecommands_P((PSTR("G1 F200 Z-3"))); // Coordinated Movement Z -3mm
  }
  if(i==3)
  {
    enqueuecommands_P((PSTR("G1 F200 Z3"))); // Coordinated Movement Z 3mm
    enqueuecommands_P((PSTR("G1 X190 F5000"))); // Coordinated Movement X:190mm Y:190mm
    enqueuecommands_P((PSTR("G1 F200 Z-3"))); // Coordinated Movement Z -3mm
  }
  if(i==4)
  {
    enqueuecommands_P((PSTR("G1 F200 Z3"))); // Coordinated Movement Z 3mm
    enqueuecommands_P((PSTR("G1 Y30 F5000"))); // Coordinated Movement X:190mm Y:30mm
    enqueuecommands_P((PSTR("G1 F200 Z-3"))); // Coordinated Movement Z -3mm
  }
  if(i==5)
  {
    enqueuecommands_P((PSTR("G1 F200 Z3"))); // Coordinated Movement Z 3mm
    enqueuecommands_P((PSTR("G1 X110 Y110 F5000"))); // Coordinated Movement X:110mm Y:110mm
    enqueuecommands_P((PSTR("G1 F200 Z-3"))); // Coordinated Movement Z -3mm
  }
  if(i==6)
  {
